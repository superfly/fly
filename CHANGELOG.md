...
* handle api token param ([91afd86](https://github.com/superfly/fly/commit/91afd86))
...
* tests not found if entry set in webpack config ([fda2bdc](https://github.com/superfly/fly/commit/fda2bdc))
...
* resolve app entry from main in package.json ([5e12ac8](https://github.com/superfly/fly/commit/5e12ac8))
...
* handle empty config files ([3070321](https://github.com/superfly/fly/commit/3070321))


### Features

* automatically detect typescript apps ([ee0808a](https://github.com/superfly/fly/commit/ee0808a))
...
* statically link libstdc on linux ([#227](https://github.com/superfly/fly/issues/227)) ([166732f](https://github.com/superfly/fly/commit/166732f))
...
* host header edge cases ([01ee466](https://github.com/superfly/fly/commit/01ee466))
