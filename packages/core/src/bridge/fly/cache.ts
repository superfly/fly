...
registerBridge("flyCacheSet", function cacheSet(
  rt: Runtime,
  bridge: Bridge,
  key: string,
...
registerBridge("flyCacheExpire", function cacheExpire(
  rt: Runtime,
  bridge: Bridge,
  key: string,
  ttl: number,
...
registerBridge("flyCacheGet", function cacheGet(
  rt: Runtime,
  bridge: Bridge,
  key: string,
  callback: ivm.Reference<() => void>
...
registerBridge("flyCacheGetMulti", function cacheGet(
  rt: Runtime,
  bridge: Bridge,
  keys: string | string[],
  callback: ivm.Reference<() => void>
...
registerBridge("flyCacheDel", function cacheDel(
  rt: Runtime,
  bridge: Bridge,
  key: string,
  callback: ivm.Reference<() => void>
...
registerBridge("flyCacheSetTags", function flyCaceSettTags(
  rt: Runtime,
  bridge: Bridge,
  key: string,
  tags: string[],
...
registerBridge("flyCachePurgeTags", function flyCacheSetTags(
  rt: Runtime,
  bridge: Bridge,
  key: string,
  callback: ivm.Reference<() => void>
...
registerBridge("flyCacheNotify", function cacheDel(
  rt: Runtime,
  bridge: Bridge,
  ...
  bridge.cacheNotifier
    .send(type, rt.app.id, key)
    .then(result => {
      callback.applyIgnored(null, [null, !!result])
    })
    .catch(err => {
