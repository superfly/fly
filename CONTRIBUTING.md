...
When you're ready to start contributing, [fork Fly](https://help.github.com/articles/fork-a-repo/) and
create a branch with an appropriate name.

A good branch name, for example, where issue #156 is the ticket you're working on, looks like this:

```sh
git checkout -b 156-update-docs
```
