...
registerBridge("fly.Data.put", function (rt: Runtime, bridge: Bridge, collName: string, key: string, obj: string, cb: ivm.Reference<Function>) {
  if (!bridge.dataStore) {
...
registerBridge("fly.Data.get", function (rt: Runtime, bridge: Bridge, collName: string, key: string, cb: ivm.Reference<Function>) {
  if (!bridge.dataStore) {
    log.error("Data store was not present")
    cb.applyIgnored(null, ["data store not present, this is a bug, please report!"])
    return
...
registerBridge("fly.Data.dropCollection", function (rt: Runtime, bridge: Bridge, collName: string, cb: ivm.Reference<Function>) {
  if (!bridge.dataStore) {
    log.error("Data store was not present")
    cb.applyIgnored(null, ["data store not present, this is a bug, please report!"])
    return
...
registerBridge("fly.Data.del", function (rt: Runtime, bridge: Bridge, collName: string, key: string, cb: ivm.Reference<Function>) {
  if (!bridge.dataStore) {
    log.error("Data store was not present")
    cb.applyIgnored(null, ["data store not present, this is a bug, please report!"])
    return
